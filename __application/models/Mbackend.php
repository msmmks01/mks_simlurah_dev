	...
	function getdata($type = "", $balikan = "", $p1 = "", $p2 = "", $p3 = "", $p4 = "")
	{
		...
		switch ($type) {
			...
			case "data_rekap_bulan":
				...
				if (!empty($this->auth['tahun'])) {
					$where .= "
						AND YEAR(a.tgl_cetak) = '" . $this->auth['tahun'] . "'
					";
				}
				...
				if ($sts_crud == "add" || $sts_crud == "edit") {
					...
					switch ($data['cl_jenis_surat_id']) {
						...
						case "33":
							...
							$array['di_keluarkan_akta_cerai'] = $data['di_keluarkan_akta_cerai'];
							$array['tgl_akta_cerai_dikelaurkan'] = $data['tgl_akta_cerai_dikelaurkan'];
