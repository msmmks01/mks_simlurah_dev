    ...
    <div class="area">
        ...
        <div class="container py-3">
            ...
            <main>
                                    ...
                                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="text-center mb-4">
                                                ...
                                                <h4 class="fw-bold text-dark" id="nomor-surat">
                                                    <?= $no_surat ?>
                                                </h4>
                                            </div>
                                            ...
                                            <div class="row text-center text-lg-start align-items-center">
                                                ...
                                                <div class="col-lg-3 text-center mb-3 mb-lg-0">
                                                    <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center" style="width:90px; height:90px;">
                                                        <i class="fa fa-user text-success" style="font-size:36px;"></i>
                                                    </div>
                                                </div>

                                                <div class="col-lg-9">
                                                    <p class="mb-1 text-muted">Telah ditandatangani secara elektronik oleh:</p>
                                                    <h5 class="fw-bold mb-1" id="nama-penandatangan">
                                                        <?= $nama ?>
                                                    </h5>
                                                    <div class="text-secondary mb-2" id="jabatan-penandatangan">
                                                        <?= $jabatan ?>
                                                    </div>
                                                    ...
                                                    <div class="small text-muted">
                                                        ...
                                                        Tanggal TTE:
                                                        <span id="tanggal-tte"><?= $date_update ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-center small text-success">
                                                ...
                                                Dokumen ini sah dan telah tervalidasi oleh sistem.
                                            </div>
                ...
                <!-- HASIL VALIDASI -->
                <div class="row mb-4 justify-content-center" id="hasil-validasi">
